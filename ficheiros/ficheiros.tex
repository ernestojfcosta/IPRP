...
Podemos visualizar os dados com pequenas alteraçoes ao código, como mostra a listagem \ref{lst:temp4}.
...
\end{lstlisting}
 ...
 Ao correr o programa obtemos o gráfico da figura \ref{fig:termp4}.
...
Desenvolva um programa que analise as temperaturas médias de várias cidades portuguesas, guardadas no ficheiro \textbf{temperaturas.txt}\footnote{Disponível em \url{ghttp://iprp.net}.}, determine os valores máximo e mínimo, e mostre o gráfico do resultado. Cada linha representa os dados referentes a  uma cidade.
\end{Exercicio}
