...
\begin{comment}
\section{Documentar}
Uma das coisas mais certas da programação é que os programas se destinam a ser lidos, seja por quem os escreveu, seja por qwuem os quer usar e/ou modificar. Daí que seja importante documentar o código que se escreve. Isso pode ser feito através de comentários ou de cadeias de caracteres colocadas em lugar específicos do programa. Vejamos um exemplo, recorrendo de novo ao caso do cálculo do peso ideal.
