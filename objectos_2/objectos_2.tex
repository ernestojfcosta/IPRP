...
A imagem \ref{fig:perdido} mostra o que acontece quando manda correr o programa geral \textbf{main\_tarta()}. Por conveniência de visualiza\c cão marcámos o inicio e o fim do percurso com pontos, verde e vermelho, respectivamente. O seu programa chama-se, no código abaixo, \textbf{navega}.\\\\
