...
Por defeito é usado o caracter de mudança de linha $\backslash n$. Temos assim uma sintaxe simples para a função \texttt{print}.

\begin{lstlisting}
print([expressao,...], sep=' ', end='\n',file=sys.sdout)
\end{lstlisting}

Como se pode ver também podemos determinar onde vai ser escrito o resultado indicando qual o canal de saída que, por defeito, é o monitor (\textit{sys.sdout}).
